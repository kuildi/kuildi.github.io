...
function slaider_l_r(flip){
  ...
  if(flip == 'left'){
  	$('.slider_w .n_s'+num_html).css({ 'left':'-960px'}, 600);
  	$('.slider_w .n_s'+num_sl).animate({ 'left':'960px'}, 600);
...
function slaider_menu(num){
  ...
  if(nm_s > num){
  	$('.slider_w .n_s'+num).css({ 'left':'-960px'}, 600);
  	$('.slider_w .n_s'+nm_s).animate({ 'left':'960px'}, 600);
